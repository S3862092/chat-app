...
var TouchRipple = React12.forwardRef(function TouchRipple2(props, ref) {
  ...
  var startCommit = React12.useCallback(function(params) {
    ...
    setRipples(function(oldRipples) {
      return [].concat(_toConsumableArray(oldRipples), [React12.createElement(Ripple_default, {
        key: nextKey.current,
        classes,
        timeout: DURATION,
        pulsate: pulsate2,
  ...
  return React12.createElement("span", _extends({
    className: clsx_m_default(classes.root, className),
    ref: container
  }, other), React12.createElement(TransitionGroup_default, {
    component: null,
    exit: true
  }, ripples));
});
...
var ButtonBase = React13.forwardRef(function ButtonBase2(props, ref) {
  ...
  }, buttonProps, other), children2, enableTouchRipple ? React13.createElement(TouchRipple_default, _extends({
    ref: rippleRef,
    center: centerRipple
...
var useEnhancedEffect3 = typeof window === "undefined" ? React14.useEffect : React14.useLayoutEffect;
var ListItem = React14.forwardRef(function ListItem2(props, ref) {
  ...
  var context = React14.useContext(ListContext_default);
  var childContext = {
    dense: dense || context.dense || false,
    alignItems
  };
  var listItemRef = React14.useRef(null);
  ...
  var children2 = React14.Children.toArray(childrenProp);
  ...
  var handleOwnRef = React14.useCallback(function(instance) {
    listItemRef.current = ReactDOM5.findDOMNode(instance);
  }, []);
  ...
  if (hasSecondaryAction) {
    ...
    return React14.createElement(ListContext_default.Provider, {
      value: childContext
    }, React14.createElement(ContainerComponent, _extends({
      className: clsx_m_default(classes.container, ContainerClassName),
      ref: handleRef
    }, ContainerProps), React14.createElement(Component, componentProps, children2), children2.pop()));
  }
  return React14.createElement(ListContext_default.Provider, {
    value: childContext
  }, React14.createElement(Component, _extends({
    ref: handleRef
  }, componentProps), children2));
});
true ? ListItem.propTypes = {
  alignItems: import_prop_types10.default.oneOf(["flex-start", "center"]),
  ...
  children: chainPropTypes(import_prop_types10.default.node, function(props) {
    var children2 = React14.Children.toArray(props.children);
  ...
  ContainerComponent: import_prop_types10.default.elementType,
...
var ListItem_default = withStyles_default(styles4, {
  name: "MuiListItem"
})(ListItem);
...
//# sourceMappingURL=chunk-B6UAXI3N.js.map
